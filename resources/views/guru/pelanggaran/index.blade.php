            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('guru.pelanggaran-siswa.create') }}" class="inline-flex items-center px-4 py-2 bg-teal-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-teal-500 focus:bg-teal-700 active:bg-teal-900">
                            Catat Pelanggaran
                        </a>
                    </div>
                            ...
                            <tbody class="bg-white divide-y divide-slate-200">
                                @forelse ($pelanggaranSiswa as $item)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700">{{ \Carbon\Carbon::parse($item->tanggal_pelanggaran)->isoFormat('D MMMM YYYY, HH:mm') }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-slate-500">Belum ada data pelanggaran tercatat.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
